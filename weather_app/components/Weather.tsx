      ...
      <div className="overlay bg-black bg-opacity-60 min-h-screen p-4 max-w-5xl mx-auto grid place-items-center">
        ...
        {loading ? (
          ...
          <div className="flex flex-col justify-center items-start max-w-4xl mx-auto w-full gap-6">
            <div className="text-white overlay p-4 bg-black bg-opacity-50 flex justify-around max-w-2xl mx-auto items-start w-full gap-8 leading-normal tracking-wider text-sm">
            ...
            <div>
              <h2 className="text-lg font-bold mb-2 text-white">Temperature</h2>
              <div className="max-w-4xl w-full overflow-x-auto">
                <LineChart
                  width={weatherData.length * 50}
                  height={300}
                  data={weatherData}
                >
